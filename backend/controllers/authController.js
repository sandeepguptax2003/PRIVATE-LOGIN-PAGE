...
const sendEmail = async (to, otp) => {
  // For ustome domain
  // host: 'smtp.99accers.com', // SMTP server of your custom domain
  //   port: 465, // Port (usually 465 for secure, 587 for non-secure)
  //   secure: true, // Use true if port is 465 (for SSL), false for 587
